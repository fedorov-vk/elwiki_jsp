...
public class ImagePlugin implements WikiPlugin, InitializablePlugin {
	...
	/**
	 * This method is used to clean away things like quotation marks which a malicious user could use to
	 * stop processing and insert javascript.
	 */
