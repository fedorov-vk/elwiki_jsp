/*
    ...
    under the License.
 */
package org.elwiki.plugins.denounce;
...
/**
 * Denounces a link by removing it from any search engine. <br>
 * The bots are listed in file denounce.properties.
 *
 * <p>
 * Parameters :
 * </p>
...
public class DenouncePlugin implements WikiPlugin {
	...
	/**
	 * Prepares the different patterns for later use. Compiling is (probably) expensive, so we do it
	 * statically at class load time.
	 */
	static {
		try {
