 ...
 */
@Deprecated
final class LuceneUpdaterOLD extends WikiBackgroundThread {
    ...
    protected LuceneUpdaterOLD( final Engine engine, final LuceneSearchProvider provider, final int initialDelay, final int indexDelay ) {
