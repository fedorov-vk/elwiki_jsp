...
/**
 * The "Search" plugin allows you to access the JSPWiki search routines and show the displays in an array on
 * your page.
 *
 * <p>
 * Parameters :
 ...
 * <li><b>set</b> - String. The JSPWiki context variable that will hold the results of the query. This allows
 * you to pass your queries to other plugins on the same page as well.</li>
