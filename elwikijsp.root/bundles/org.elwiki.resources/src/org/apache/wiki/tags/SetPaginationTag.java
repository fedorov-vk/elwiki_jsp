 ...
 * <li>fmtkey - pagination prefix of the i18n resource keys. Following keys are
 * used: <br>
 ...
 * @since 2.5.109
 */
public class SetPaginationTag extends BaseWikiTag {

	private static final long serialVersionUID = 2531643194601383493L;
	...
	public int doWikiStartTag() throws IOException, ProviderException, JspTagException {
		...
		//(Total items: " + m_total + ")" );
		pagination
				.append(LocaleSupport.getLocalizedMessage(pageContext, m_fmtkey + ".total", new Object[] { m_total }));
