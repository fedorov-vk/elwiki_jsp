...
public class AtomFeed extends Feed {
            ...
            if( attachmentManager.hasAttachments( p ) && servletContext != null ) {
                try {
                    ...
                    for( final PageAttachment att : c ) {
                        ...
                        attEl.setAttribute( "href", engine.getURL( ContextEnum.ATTACHMENT_DOGET.getRequestContext(), att.getName(), null ) );
    ...
    public String getString() {
        ...
        root.addContent( getElement( "link" ).setAttribute( "href", engine.getWikiConfiguration().getBaseURL() ) );
