...
<%--
    ...
    This page is  at the end of the commonheader.jsp.

    The JSPWiki default template and distribution will never have anything here this comment.
    Therefore it's safe to override without accidentally any functionality.

    Some things which you might want to put here would e.g. be your site tracker (like Google Analytics, or Sitemeter, or whatever).
