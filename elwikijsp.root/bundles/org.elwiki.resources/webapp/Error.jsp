...
%><%
    ...
    try {
    	...
    	wikiContext = Wiki.context().create( wiki, request, ContextEnum.WIKI_ERROR.getRequestContext() );
    	pagereq = wikiContext.getName();
    ...
    if(exception==null) { exception = new Exception("Test Error.jsp (:FVK:)"); }
...
<html lang="<c:out value='${prefs.Language}' default='en'/>" name="top">
  ...
  <body>
   ...
   <dl>
      <dt>Error Message</dt>
      <dd>
         <% out.println( msg ); %> <!-- :FVK: WORKAROUND. -->
