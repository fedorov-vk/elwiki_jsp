...
%>
<c:set var="history" value="<%=WikiEngine.getPageManager().getVersionHistory(c.getPage().getName())%>" />
<c:set var="diffprovider" value='<%=WikiEngine.getVariableManager().getVariable(c,"jspwiki.diffProvider")%>' />
<wiki:PageExists>
