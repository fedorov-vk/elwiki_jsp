...
<%
   ...
   String pageAsHtml = StringEscapeUtils.escapeEcmaScript( ServicesRefs.getRenderingManager().getHTML( context, usertext ) );
   ...
   String templateDir = (String)engine.getWikiPreferences().get( Engine.PROP_TEMPLATEDIR );
