...
public class CreoleToJSPWikiTranslator
{
     ...
     *
     * @param TextUtilprop A property set
     * @param content The content to translate?
     * @param username The username in the signature?
     * @return Probably some translated content.
     */
    public String translateSignature(IPreferenceStore prop, final String content, String username)
    {

        String dateFormat = TextUtil.getStringProperty(prop, "creole.dateFormat", null);
     ...
     *
     *  @param  A set of Wiki Properties
     *  @param content Creole markup
     *  @return Wiki markup
     */
    public String translate(IPreferenceStore prop, final String content)
    {
        ...
        */
        String imagePlugin = TextUtil.getStringProperty(prop, "creole.imagePlugin.name", null);
        ...
        {
            result = this.replaceImageArea(prop, result, CREOLE_LINK_IMAG_X, JSPWIKI_LINK_IMAGE_X, 6, imagePlugin);
            result = this.replaceImageArea(prop, result, CREOLE_IMAGE_X, JSPWIKI_IMAGE_X, 5, imagePlugin);
        }
    ...
    private String replaceImageArea(IPreferenceStore wikiProps, String content, String markupRegex, String replaceContent, int groupPos,
                                    String imagePlugin)
    {
