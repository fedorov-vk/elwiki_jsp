...
/**
 * SPI used to locate and provide {@link WikiContext} instances.
 */
public interface ContextSPI {
     ...
     */
    WikiContext create( Engine engine, WikiPage page );
     ...
     */
    WikiContext create( Engine engine, HttpServletRequest request, Command command );
     ...
     */
    WikiContext create( Engine engine, HttpServletRequest request, WikiPage page );
     ...
     */
    WikiContext create( Engine engine, HttpServletRequest request, String requestContext );
