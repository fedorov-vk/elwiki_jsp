/*
    ...
    under the License.
 */
package org.apache.wiki.api.variables;
...
public interface VariableManager extends WikiManager {
     ...
     *  {@link org.apache.wiki.parser0.LinkParsingOperations#isVariableLink(String) LinkParsingOperations#isVariableLink(String)}
     ...
     *    <li>ElWiki configuration (PreferenceStore related to file preferences.ini)
     *  </ol>
     *
