...
public interface PluginElement {
	...
	/**
	 * The main invocation for the plugin. When the getText() is called, it invokes the plugin and
	 * returns its contents. If there is no Document yet, only returns the plugin name itself.
	 *
	 ...
	 */
	String invoke(@NonNull WikiContext context);
