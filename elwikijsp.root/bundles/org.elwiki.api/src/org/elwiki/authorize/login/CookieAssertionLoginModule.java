...
import org.elwiki.authorize.login.AbstractLoginModule;
...
public class CookieAssertionLoginModule extends AbstractLoginModule {
	...
	public boolean login() throws LoginException {
		...
		try {
			...
			this.m_principals.add(new WikiPrincipal(name, WikiPrincipal.FULL_NAME));
			return true;
		} catch (IOException e) {
	 ...
	 */
	public static void setUserCookie(HttpServletResponse response, String name1) {
		String name = name1;
