...
/**
 * Provides a factory for Permission objects. Since the Permissions are immutable, and
 * creating them takes a bit of time, caching them makes sense.
 * <p>
...
public final class PermissionFactory {
	...
	/**
	 * This is a WeakHashMap<Integer,PagePermission>, which stores the cached page
	 * permissions.
	 */
	 ...
	 * 
	 * @param wiki
	 *            The name of the wiki. Can be an empty string, but must not be null.
	 * @param page
	 *            The page name
	 * @param actions
	 *            A list of actions.
