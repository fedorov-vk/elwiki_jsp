...
public class AclEntryImpl extends CDOObjectImpl implements AclEntry {
	 ...
	 * @generated
	 */
	public Permission findPermission(final Permission p) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case Elwiki_dataPackage.ACL_ENTRY___FIND_PERMISSION__PERMISSION:
				return findPermission((Permission)arguments.get(0));
		}
