...
public class StringToObjectMapItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Elwiki_dataPackage.Literals.STRING_TO_OBJECT_MAP__KEY,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Elwiki_dataPackage.Literals.STRING_TO_OBJECT_MAP__VALUE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Map.Entry.class)) {
			case Elwiki_dataPackage.STRING_TO_OBJECT_MAP__KEY:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case Elwiki_dataPackage.STRING_TO_OBJECT_MAP__VALUE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Elwiki_dataPackage.Literals.STRING_TO_OBJECT_MAP__VALUE,
