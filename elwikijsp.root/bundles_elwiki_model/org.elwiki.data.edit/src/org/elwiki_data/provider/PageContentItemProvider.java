...
/**
 * This is the item provider adapter for a {@link org.elwiki_data.PageContent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PageContentItemProvider 
	...
	protected void addContentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PageContent_content_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PageContent_content_feature", "_UI_PageContent_type"),
				 Elwiki_dataPackage.Literals.PAGE_CONTENT__CONTENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_PageContent_type") + " " + pageContent.getVersion();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PageContent.class)) {
			case Elwiki_dataPackage.PAGE_CONTENT__VERSION:
			case Elwiki_dataPackage.PAGE_CONTENT__LAST_MODIFY:
			case Elwiki_dataPackage.PAGE_CONTENT__AUTHOR:
			case Elwiki_dataPackage.PAGE_CONTENT__CHANGE_NOTE:
			case Elwiki_dataPackage.PAGE_CONTENT__CONTENT:
