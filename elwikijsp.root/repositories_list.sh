...
export CUSTOM_REPO01=$P2_REPO_PLACE/apache-tools/target/repository
export CUSTOM_REPO02=$P2_REPO_PLACE/custom-p2-site/target/repository
export CUSTOM_REPO03=$P2_REPO_PLACE/additional-artifacts/target/repository
