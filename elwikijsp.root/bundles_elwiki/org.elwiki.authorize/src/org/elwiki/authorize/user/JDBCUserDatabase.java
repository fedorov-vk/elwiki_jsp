...
public class JDBCUserDatabase extends AbstractUserDatabase {
    ...
    /**
     * @see org.apache.wiki.auth.user0.UserDatabase#findByWikiName(String)
     */
    @Override
    ...
    /**
     * @see org.apache.wiki.auth.user0.UserDatabase#rename(String, String)
     */
    @Override
    ...
    /**
     * @see org.apache.wiki.auth.user0.UserDatabase#save(org.apache.wiki.auth.user0.UserProfile)
     */
    @Override
	...
	protected void prepareProfile(UserProfile profile, User user) {
		// :FVK: TODO Auto-generated method stub
		try {
			throw new Exception();
		} catch (Exception e) {
