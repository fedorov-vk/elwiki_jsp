...
/**
 * <p>
 * Logs in a user based solely on IP address; no other authentication is performed. Barring a
 * mis-configuration or I/O error, this LoginModule <em>always</em> succeeds.
 * </p>
 ...
 * </p>
 * <ol>
 * <li>{@link HttpRequestCallback}- supplies the IP address, which is used as a backup in case no name is
 * supplied.</li>
 * </ol>
 * <p>
 * After authentication, a generic WikiPrincipal based on the IP address will be created and associated with
 * the Subject.
 * 
